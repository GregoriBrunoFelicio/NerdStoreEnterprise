...
namespace NSE.Identidade.API.Controllers
{
    ...
    public class AuthController : Controller
    {
        ...
        private async Task<UsuarioRespostaLogin> GerarJwt(string email)
        {
            ...
            claims.Add(new Claim(JwtRegisteredClaimNames.Jti, ToUnitEpochDate(DateTime.UtcNow).ToString(),
        ...
        private static long ToUnitEpochDate(DateTime date) => (long)Math.Round(
